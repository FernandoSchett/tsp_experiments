# ==============================================
# Script Name:    run_multist_semi_nn_heur_k_chosen_insts.sh
# Description:    Run SEMI-NN (k scheme) heuristic on chosen instances and create logs and results
# Author:         Fernando Schettini (Fernandoschettini@outlook.com) and Vitor Barbosa
# Created Date:   22/07/2024
# How to run it:  bash run_multist_semi_nn_heur_k_chosen_insts.sh
# ==============================================
