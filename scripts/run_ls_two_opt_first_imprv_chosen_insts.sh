...
do
    ...
    echo "./TSP -f  $i -l nn_heur_i1 -c local_search -r two_opt_first_imprv >> benchmark/logs/local_search_first_improvement/$inst_name.txt" 
    ./TSP -f  $i -l nn_heur_i1 -c local_search -r two_opt_first_imprv >> benchmark/logs/local_search_first_improvement/$inst_name.txt
done
